# Embedded file name: /usr/lib/enigma2/python/Components/Converter/MaggyCryptInfo.py
                    ...
                    if ecm_info:
                        ...
                        if self.type == self.ALL:
                            if source == 'emu':
                                ...
                                textvalue = '%s - Prov: %s, Caid: %s, Reader: %s, %s (%s:%s) - %s, %s hops' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
                                ...
                                textvalue = '%s - Prov: %s, Caid: %s, Reader: %s, %s (%s) - %s, %s hops' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
                                ...
                                textvalue = '%s - Prov: %s, Caid: %s, Reader: %s, %s (local) - %s, %s hops' % (source,
                                 prov,
                                 caid,
                                 reader,
                                 protocol,
